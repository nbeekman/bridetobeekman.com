  ...
  <div id="welcome" style={ styles.container }>
    ...
    <div>
      ...
      <div style={ styles.textCont }>
        ...
        <p style={ styles.text }>We cannot wait until August 19 so we can share our special day with you!</p>
        <p style={ styles.text }>We&#8217;re privileged to have you in our lives and we truly appreciate your love and support!</p>
        <p style={ styles.textBottomMargin }>And really, we&#8217;re just looking forward to celebrating with all your beautiful faces!</p>
